  ...
  (function(_React$Component) {
    ...
    function ScrollTransition(props) {
      ...
      _this = _possibleConstructorReturn(
        this,
        (
          ScrollTransition.__proto__ || Object.getPrototypeOf(ScrollTransition)
        ).call(this, props)
      );
      _this.getListStyles = _this.getListStyles.bind(
      ...
      },
      {
        ...
        value: function getSlideStyles(index, positionValue) {
          ...
          return {
            ...
            marginLeft: this.props.vertical
              ? "auto"
              : this.props.cellSpacing / 2,
            marginRight: this.props.vertical
              ? "auto"
              : this.props.cellSpacing / 2,
            marginTop: this.props.vertical
              ? this.props.cellSpacing / 2
              : "auto",
      ...
      },
      {
        ...
        value: function getListStyles(styles) {
          ...
          return {
            ...
            boxSizing: "border-box",
            MozBoxSizing: "border-box",
            touchAction: "pinch-zoom ".concat(
              this.props.vertical ? "pan-x" : "pan-y"
            )
          };
        }
      },
